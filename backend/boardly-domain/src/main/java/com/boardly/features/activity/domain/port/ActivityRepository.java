package com.boardly.features.activity.domain.port;
...
public interface ActivityRepository {
     ...
     */
    List<Activity> findByBoardIdOrderByTimestampDesc(
        BoardId boardId,
        int page,
        int size
    );
     ...
     */
    List<Activity> findByActorIdOrderByTimestampDesc(
        UserId userId,
        int page,
        int size
    );
     ...
     */
    List<Activity> findByBoardIdAndTimestampBetween(
        BoardId boardId,
        Instant startTime,
        Instant endTime
    );
     ...
     */
    List<Activity> findByBoardIdAndTimestampAfter(
        BoardId boardId,
        Instant after
    );
