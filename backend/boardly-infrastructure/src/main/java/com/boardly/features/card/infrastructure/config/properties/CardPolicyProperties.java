package com.boardly.features.card.infrastructure.config.properties;
...
public class CardPolicyProperties {
    ...
    public void logLoadedConfiguration() {
        ...
        log.info(
            "  - Max cards per list: {}",
            maxCardsPerList > 0 ? maxCardsPerList : "Not set (using default)"
        );
        log.info(
            "  - Max title length: {}",
            maxTitleLength > 0 ? maxTitleLength : "Not set (using default)"
        );
        log.info(
        ...
        log.info(
            "  - Max search results: {}",
            maxSearchResults > 0 ? maxSearchResults : "Not set (using default)"
        );
    }
