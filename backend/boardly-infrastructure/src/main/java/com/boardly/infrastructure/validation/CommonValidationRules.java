...
public class CommonValidationRules {
    ...
    public static <T> Validator<T> idRequired(
    ...
    public <T> Validator<T> passwordComplete(
    ...
    public <T> Validator<T> firstNameComplete(
        Function<T, String> firstNameExtractor
    ) {
        return Validator.chain(
    ...
    public <T> Validator<T> lastNameComplete(
    ...
    public <T> Validator<T> descriptionComplete(
    ...
    public <T> Validator<T> userIdRequired(
        Function<T, Object> userIdExtractor
    ) {
        return idRequired(userIdExtractor, "userId", messageResolver);
    }

    public <T> Validator<T> boardIdRequired(
        Function<T, Object> boardIdExtractor
    ) {
        return idRequired(boardIdExtractor, "boardId", messageResolver);
    }

    public <T> Validator<T> listIdRequired(
        Function<T, Object> listIdExtractor
    ) {
        return idRequired(listIdExtractor, "listId", messageResolver);
    }

    public <T> Validator<T> cardIdRequired(
        Function<T, Object> cardIdExtractor
    ) {
        return idRequired(cardIdExtractor, "cardId", messageResolver);
    }

    public <T> Validator<T> commentIdRequired(
        Function<T, Object> commentIdExtractor
    ) {
        return idRequired(commentIdExtractor, "commentId", messageResolver);
    }

    public <T> Validator<T> positionRequired(
        Function<T, Object> positionExtractor
    ) {
        return Validator.fieldWithMessage(
            positionExtractor,
            value -> value != null,
    ...
    public <T> Validator<T> listColorRequired(
        Function<T, Object> colorExtractor
    ) {
        return Validator.chain(
            ...
            Validator.fieldWithMessage(
                ...
                value -> {
                    ...
                    if (value instanceof ListColor listColor) {
                        return ListColor.isValidColor(listColor.color());
                    }
                    return false;
                },
                "color",
     ...
     */
    public <T> Validator<T> cardTitleComplete(
     ...
     */
    public <T> Validator<T> cardDescriptionComplete(
        Function<T, String> descriptionExtractor
    ) {
        return Validator.chain(
            maxLength(
     ...
     */
    public <T> Validator<T> boardMemberRoleRequired(
     ...
     */
    public <T> Validator<T> cardDateRangeValid(
        Function<T, Instant> startDateExtractor,
