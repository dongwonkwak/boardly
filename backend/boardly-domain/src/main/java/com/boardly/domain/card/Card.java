...
import com.boardly.domain.board.ColumnId;
...
public class Card {
    ...
    @Builder
    public Card(CardId id, String title, String description, ColumnId columnId,
     ...
     * 카드 생성 팩토리 메서드
     */
    public static Card create(String title, String description, ColumnId columnId, int order, LocalDate dueDate) {
        return Card.builder()
                .id(CardId.generate())
                .title(title)
     ...
     * 카드 이동
     */
    public void moveToColumn(ColumnId newColumnId, int newOrder) {
