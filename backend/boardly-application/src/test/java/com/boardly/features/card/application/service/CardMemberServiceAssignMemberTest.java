...
@DisplayName("CardMemberService assignMember 테스트")
class CardMemberServiceAssignMemberTest {
        ...
        class AssignMemberTest {
                ...
                void shouldAssignMemberSuccessfully() {
                        // given
                        ValidationResult<AssignCardMemberCommand> validResult = ValidationResult.valid(validCommand);
                        when(validator.validateAssign(validCommand)).thenReturn(validResult);
                ...
                void shouldReturnFailureWhenValidationFails() {
                        // given
                        ValidationResult<AssignCardMemberCommand> invalidResult = ValidationResult.invalid("title",
                                        "제목은 필수입니다.", null);
                        when(validator.validateAssign(validCommand)).thenReturn(invalidResult);
                ...
                void shouldReturnFailureWhenMemberAlreadyAssigned() {
                        ...
                        // then
                        assertThat(result.isLeft()).isTrue();
                        assertThat(result.getLeft().getMessage()).isEqualTo("이미 할당된 멤버입니다.");
