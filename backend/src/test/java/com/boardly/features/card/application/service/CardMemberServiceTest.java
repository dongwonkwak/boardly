...
class CardMemberServiceTest {
    ...
    class AssignMemberTest {
        ...
        void shouldAssignMemberSuccessfully() {
            ...
            when(userRepository.findUserNameById(memberId))
        ...
        void shouldReturnFailureWhenValidationFails() {
            // given
            ValidationResult<AssignCardMemberCommand> invalidResult = ValidationResult.invalid(
            ...
            verifyNoInteractions(cardRepository, userRepository, cardMemberRepository, activityHelper);
        }
        ...
        void shouldReturnFailureWhenCardNotFound() {
            ...
            verifyNoInteractions(userRepository, cardMemberRepository, activityHelper);
        }
    ...
    class ActivityLogTest {
        ...
        private UnassignCardMemberCommand unassignCommand;
        private Card card;
        private UserNameDto memberName;
        private BoardList boardList;
        private Board board;
        ...
        void setUp() {
            ...
            unassignCommand = new UnassignCardMemberCommand(cardId, memberId, requesterId);
