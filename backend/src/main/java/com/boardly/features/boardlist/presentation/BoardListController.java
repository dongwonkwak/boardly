...
@Tag(name = "BoardLists", description = "BoardLists API")
public class BoardListController {

  private static final String TAGS = "BoardLists";
  ...
  @Operation(summary = "보드 리스트 목록 조회", description = "특정 보드에 속한 모든 리스트를 position 순서대로 조회합니다.", tags = {
  ...
  @Operation(summary = "보드 리스트 생성", description = "특정 보드에 새로운 리스트를 생성합니다.", tags = {
      TAGS }, security = @SecurityRequirement(name = "oauth2", scopes = { "read", "write", "openid" }))
  @ApiResponses(value = {
  ...
  @Operation(summary = "보드 리스트 수정", description = "특정 보드 리스트의 정보를 수정합니다.", tags = {
      TAGS }, security = @SecurityRequirement(name = "oauth2", scopes = { "read", "write", "openid" }))
  @ApiResponses(value = {
  ...
  @Operation(summary = "보드 리스트 삭제", description = "특정 보드 리스트를 삭제합니다.", tags = {
  ...
  @Operation(summary = "보드 리스트 위치 변경", description = "특정 보드 리스트의 위치를 변경합니다.", tags = {
      TAGS }, security = @SecurityRequirement(name = "oauth2", scopes = { "write", "openid" }))
  @ApiResponses(value = {
