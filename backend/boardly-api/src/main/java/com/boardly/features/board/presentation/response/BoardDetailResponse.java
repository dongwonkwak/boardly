...
import com.boardly.features.card.domain.*;
import com.boardly.shared.common.value.*;
import com.boardly.features.label.domain.*;
import com.boardly.features.user.domain.*;
...
public record BoardDetailResponse(
    ...
    private static BoardCardResponse convertToBoardCardResponse(
        com.boardly.features.card.domain.Card card,
