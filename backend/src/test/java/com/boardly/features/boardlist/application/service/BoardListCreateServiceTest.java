...
class BoardListCreateServiceTest {
    ...
    class SuccessCases {
        ...
        void createBoardList_withEmptyDescription_shouldSucceed() {
            // given
            CreateBoardListCommand emptyDescriptionCommand =
            ...
            ValidationResult<CreateBoardListCommand> validResult =
                ValidationResult.valid(emptyDescriptionCommand);
            ...
            when(
                boardListValidator.validateCreateBoardList(
                    emptyDescriptionCommand
                )
            ).thenReturn(validResult);
            when(boardRepository.findById(testBoardId)).thenReturn(
                Optional.of(testBoard)
            ...
            when(boardListRepository.save(any(BoardList.class))).thenReturn(
                createdBoardListWithEmptyDesc
            );

            // when
            Either<Failure, BoardList> result =
                boardListCreateService.createBoardList(emptyDescriptionCommand);
        ...
        void createBoardList_withNullDescription_shouldSucceed() {
            // given
            CreateBoardListCommand nullDescriptionCommand =
                new CreateBoardListCommand(
                    testBoardId,
                    testUserId,
                    "테스트 리스트",
            ...
            ValidationResult<CreateBoardListCommand> validResult =
                ValidationResult.valid(nullDescriptionCommand);
            ...
            when(boardListRepository.save(any(BoardList.class))).thenReturn(
                createdBoardListWithNullDesc
            );

            // when
            Either<Failure, BoardList> result =
                boardListCreateService.createBoardList(nullDescriptionCommand);
        ...
        void createBoardList_withExactMaxTitleLength_shouldSucceed() {
            ...
            CreateBoardListCommand maxLengthCommand =
                new CreateBoardListCommand(
                    testBoardId,
                    testUserId,
                    maxLengthTitle,
            ...
            ValidationResult<CreateBoardListCommand> validResult =
                ValidationResult.valid(maxLengthCommand);
            ...
            when(
                boardListValidator.validateCreateBoardList(maxLengthCommand)
            ).thenReturn(validResult);
            when(boardRepository.findById(testBoardId)).thenReturn(
                Optional.of(testBoard)
            );
            ...
            when(boardListRepository.save(any(BoardList.class))).thenReturn(
                createdBoardListWithMaxTitle
            );

            // when
            Either<Failure, BoardList> result =
                boardListCreateService.createBoardList(maxLengthCommand);
    ...
    class InputValidationFailureCases {
        ...
        void createBoardList_withInvalidData_shouldReturnInputError() {
            ...
            Failure.InputError inputError =
                (Failure.InputError) result.getLeft();
            ...
            verify(boardListValidator).validateCreateBoardList(validCommand);
            verify(validationMessageResolver).getMessage(
    ...
    class BoardAccessFailureCases {
        ...
        void createBoardList_withUnauthorizedAccess_shouldReturnPermissionDenied() {
            ...
            CreateBoardListCommand unauthorizedCommand =
                new CreateBoardListCommand(
                    testBoardId,
                    unauthorizedUserId,
                    "테스트 리스트",
            ...
            when(
                boardListValidator.validateCreateBoardList(unauthorizedCommand)
            ).thenReturn(validResult);
            when(boardRepository.findById(testBoardId)).thenReturn(
                Optional.of(testBoard)
            );
            ...
            // when
            Either<Failure, BoardList> result =
                boardListCreateService.createBoardList(unauthorizedCommand);
            ...
            Failure.PermissionDenied permissionDenied =
                (Failure.PermissionDenied) result.getLeft();
            ...
            verify(boardListValidator).validateCreateBoardList(
                unauthorizedCommand
            );
            verify(boardRepository).findById(testBoardId);
            verify(validationMessageResolver).getMessage(
    ...
    class BusinessRuleViolationCases {
        ...
        void createBoardList_withPolicyViolation_shouldReturnBusinessRuleViolation() {
            ...
            Failure.BusinessRuleViolation businessRuleViolation =
                (Failure.BusinessRuleViolation) result.getLeft();
            ...
            assertThat(businessRuleViolation.getContext()).isInstanceOf(
                Map.class
            );
            assertThat(
    ...
    class SystemErrorCases {
        ...
        void createBoardList_withSaveException_shouldReturnInternalError() {
            ...
            ValidationResult<CreateBoardListCommand> validResult =
                ValidationResult.valid(validCommand);
            RuntimeException saveException = new RuntimeException(
                "데이터베이스 연결 오류"
            );
            ...
            Failure.InternalError internalError =
                (Failure.InternalError) result.getLeft();
        ...
        void createBoardList_withMaxPositionException_shouldReturnInternalError() {
            ...
            ValidationResult<CreateBoardListCommand> validResult =
                ValidationResult.valid(validCommand);
            RuntimeException maxPositionException = new RuntimeException(
                "위치 조회 오류"
            );
            ...
            when(
                boardListRepository.findMaxPositionByBoardId(testBoardId)
            ).thenThrow(maxPositionException);
    ...
    class ActivityHelperVerification {
        ...
        @Test
        @DisplayName(
            "리스트 생성 성공 시 ActivityHelper.logListCreate가 호출되어야 한다"
        )
        ...
        @Test
        @DisplayName(
            "리스트 생성 실패 시 ActivityHelper가 호출되지 않아야 한다"
        )
