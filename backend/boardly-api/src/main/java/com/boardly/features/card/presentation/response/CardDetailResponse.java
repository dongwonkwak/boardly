...
public record CardDetailResponse(
    ...
    public record AssigneeResponse(
        ...
        public static AssigneeResponse from(
                com.boardly.features.card.domain.CardMember cardMember) {
    ...
    public record AttachmentResponse(
        ...
        public static AttachmentResponse from(
                com.boardly.features.card.domain.CardAttachment attachment) {
    ...
    public record CommentResponse(
        ...
        public static CommentResponse from(com.boardly.features.card.domain.CardComment comment) {
    ...
    public record BoardMemberResponse(
        ...
        public static BoardMemberResponse from(com.boardly.features.board.domain.BoardMember boardMember) {
    ...
    public record ActivityResponse(
        ...
        public static ActivityResponse from(com.boardly.features.card.domain.CardActivity activity) {
