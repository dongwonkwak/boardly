...
public class BoardListPolicyConfigImpl implements BoardListPolicyConfig {
    ...
    public int getMaxListsPerBoard() {
        return maxListsPerBoard != null
            ? maxListsPerBoard
            : Defaults.MAX_LISTS_PER_BOARD;
    }

    @Override
    public int getRecommendedListsPerBoard() {
        return recommendedListsPerBoard != null
            ? recommendedListsPerBoard
            : Defaults.RECOMMENDED_LISTS_PER_BOARD;
    }
