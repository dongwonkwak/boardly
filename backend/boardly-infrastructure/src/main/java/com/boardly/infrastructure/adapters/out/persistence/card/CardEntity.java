...
import com.boardly.features.card.domain.CardPriority;
...
@Table(name = "cards", indexes = {
        ...
        @Index(name = "idx_cards_workspace_id", columnList = "workspace_id")
})
@Getter
...
public class CardEntity {
    ...
    private CardEntity(String cardId, String title, String description,
            int position, String listId, String workspaceId,
    ...
    public Card toDomainEntity() {
        ...
        return Card.restore(
                ...
                new WorkspaceId(this.workspaceId),
    ...
    public static CardEntity from(Card card) {
        var entity = CardEntity.builder()
                ...
                .workspaceId(card.getWorkspaceId().getId())
    ...
    public void updateFromDomainEntity(Card card) {
        ...
        this.workspaceId = card.getWorkspaceId().getId();
