...
public class BoardValidator {
    ...
    public ValidationResult<CreateBoardCommand> validateCreate(
        CreateBoardCommand command
    ) {
        return getCreateValidator().validate(command);
    }

    public ValidationResult<UpdateBoardCommand> validateUpdate(
        UpdateBoardCommand command
    ) {
        return getUpdateValidator().validate(command);
    }

    public ValidationResult<DeleteBoardCommand> validateDelete(
        DeleteBoardCommand command
    ) {
        return getDeleteValidator().validate(command);
    }

    public ValidationResult<ArchiveBoardCommand> validateArchive(
        ArchiveBoardCommand command
    ) {
        return getArchiveValidator().validate(command);
    }

    public ValidationResult<GetBoardDetailQuery> validateGetDetail(
        GetBoardDetailQuery command
    ) {
    ...
    public ValidationResult<ToggleStarBoardCommand> validateToggleStar(
    ...
    public ValidationResult<AddBoardMemberCommand> validateAddMember(
        AddBoardMemberCommand command
    ) {
        return getAddMemberValidator().validate(command);
    }

    public ValidationResult<RemoveBoardMemberCommand> validateRemoveMember(
    ...
    > validateUpdateMemberRole(UpdateBoardMemberRoleCommand command) {
    ...
    private Validator<CreateBoardCommand> getCreateValidator() {
        return Validator.combine(
            ...
            commonValidationRules.descriptionComplete(
    ...
    private Validator<UpdateBoardCommand> getUpdateValidator() {
        return Validator.combine(
            ...
            commonValidationRules.userIdRequired(
                UpdateBoardCommand::requestedBy
            ),
            commonValidationRules.titleOptional(UpdateBoardCommand::title),
            commonValidationRules.descriptionComplete(
                UpdateBoardCommand::description
            )
        );
    }
    ...
    private Validator<DeleteBoardCommand> getDeleteValidator() {
        return Validator.combine(
            ...
            commonValidationRules.userIdRequired(
                DeleteBoardCommand::requestedBy
            )
        );
    }
    ...
    private Validator<ArchiveBoardCommand> getArchiveValidator() {
        return Validator.combine(
            ...
            commonValidationRules.userIdRequired(
                ArchiveBoardCommand::requestedBy
            )
        );
    }

    private Validator<GetBoardDetailQuery> getGetDetailValidator() {
        return Validator.combine(
            commonValidationRules.boardIdRequired(GetBoardDetailQuery::boardId),
            commonValidationRules.userIdRequired(GetBoardDetailQuery::userId)
        );
    }

    private Validator<ToggleStarBoardCommand> getToggleStarValidator() {
        return Validator.combine(
            commonValidationRules.boardIdRequired(
                ToggleStarBoardCommand::boardId
            ),
            commonValidationRules.userIdRequired(
                ToggleStarBoardCommand::requestedBy
            )
        );
    }
    ...
    private Validator<AddBoardMemberCommand> getAddMemberValidator() {
        return Validator.combine(
            commonValidationRules.boardIdRequired(
                AddBoardMemberCommand::boardId
            ),
            commonValidationRules.userIdRequired(AddBoardMemberCommand::userId),
            commonValidationRules.boardMemberRoleRequired(
                AddBoardMemberCommand::role
            ),
            commonValidationRules.userIdRequired(
                AddBoardMemberCommand::requestedBy
            )
        );
    }
    ...
    private Validator<RemoveBoardMemberCommand> getRemoveMemberValidator() {
        return Validator.combine(
            commonValidationRules.boardIdRequired(
                RemoveBoardMemberCommand::boardId
            ),
            commonValidationRules.userIdRequired(
                RemoveBoardMemberCommand::targetUserId
            ),
            commonValidationRules.userIdRequired(
                RemoveBoardMemberCommand::requestedBy
            )
        );
    }
    ...
    private Validator<
        UpdateBoardMemberRoleCommand
    > getUpdateMemberRoleValidator() {
        return Validator.combine(
            commonValidationRules.boardIdRequired(
                UpdateBoardMemberRoleCommand::boardId
            ),
            commonValidationRules.userIdRequired(
                UpdateBoardMemberRoleCommand::targetUserId
            ),
            commonValidationRules.boardMemberRoleRequired(
                UpdateBoardMemberRoleCommand::newRole
            ),
            commonValidationRules.userIdRequired(
                UpdateBoardMemberRoleCommand::requestedBy
            )
        );
    }
}
