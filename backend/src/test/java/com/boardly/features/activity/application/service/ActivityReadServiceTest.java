...
class ActivityReadServiceTest {
        ...
        class GetActivitiesSuccessTest {
                ...
                void getActivities_WithBoardId_ShouldSucceed() {
                        ...
                        GetActivityQuery query = GetActivityQuery.builder()
                                        .boardId(boardId)
                                        .page(0)
                                        .size(10) // size를 명시적으로 설정하여 페이징이 있는 것으로 간주
                                        .build();

                        List<Activity> mockActivities = createMockActivities();
                        when(activityRepository.findByBoardIdOrderByTimestampDesc(boardId, 0, 10))
                        ...
                        verify(activityRepository).findByBoardIdOrderByTimestampDesc(boardId, 0, 10);
                ...
                void getActivities_WithUserId_ShouldSucceed() {
                        ...
                        List<Activity> mockActivities = createMockActivities();
                        when(activityRepository.findByActorIdOrderByTimestampDesc(userId, 0, 10))
                                        .thenReturn(mockActivities);
                        ...
                        verify(activityRepository).findByActorIdOrderByTimestampDesc(userId, 0, 10);
                ...
                void getActivities_WithBoardIdAndPaging_ShouldSucceed() {
                        ...
                        List<Activity> mockActivities = createMockActivities();
                        when(activityRepository.findByBoardIdOrderByTimestampDesc(boardId, page, size))
                                        .thenReturn(mockActivities);
                        ...
                        verify(activityRepository).findByBoardIdOrderByTimestampDesc(boardId, page, size);
                        verify(activityRepository).countByBoardId(boardId);
                }
                ...
                void getActivities_WithUserIdAndPaging_ShouldSucceed() {
                        ...
                        List<Activity> mockActivities = createMockActivities();
                        when(activityRepository.findByActorIdOrderByTimestampDesc(userId, page, size))
                                        .thenReturn(mockActivities);
                        ...
                        verify(activityRepository).findByActorIdOrderByTimestampDesc(userId, page, size);
                        verify(activityRepository).countByActorId(userId);
                }
                ...
                void getActivities_WithBoardIdAndTimeRange_ShouldSucceed() {
                        ...
                        List<Activity> mockActivities = createMockActivities();
                        when(activityRepository.findByBoardIdAndTimestampBetween(boardId, since, until))
                                        .thenReturn(mockActivities);
                ...
                void getActivities_WithBoardIdAndSinceOnly_ShouldSucceed() {
                        ...
                        List<Activity> mockActivities = createMockActivities();
                        when(activityRepository.findByBoardIdAndTimestampAfter(boardId, since))
                                        .thenReturn(mockActivities);
                ...
                void getActivities_WithDefaultPaging_ShouldSucceed() {
                        ...
                        verify(activityRepository).findByBoardIdOrderByTimestampDesc(boardId);
                }
        }
        ...
        class GetActivitiesFailureTest {
                ...
                void getActivities_WithNoBoardIdAndNoUserId_ShouldReturnFailure() {
                        // given
                        GetActivityQuery query = GetActivityQuery.builder().build();

                        when(messageSource.getMessage(eq("validation.activity.query.invalid"), any(Object[].class),
                        ...
                        assertThat(failure.getMessage()).contains("보드 ID 또는 사용자 ID 중 하나는 필수입니다");
                }

                @Test
                @DisplayName("보드 ID와 사용자 ID가 모두 null일 때 실패를 반환해야 한다")
                ...
                void getActivities_WithException_ShouldReturnFailure() {
                        ...
                        when(messageSource.getMessage(eq("activity.read.error"), any(Object[].class), anyString(),
                                        any(Locale.class)))
                        ...
                        assertThat(failure.getMessage()).contains("활동 목록 조회 중 오류가 발생했습니다");
                }
        }
        ...
        class ActivityResponseConversionTest {
                ...
                void activity_ShouldBeConvertedToActivityResponseCorrectly() {
                        ...
                        assertThat(actorResponse.firstName()).isEqualTo("홍");
                        assertThat(actorResponse.lastName()).isEqualTo("길동");
                        assertThat(actorResponse.profileImageUrl()).isEqualTo("https://example.com/profile.jpg");

                        Map<String, Object> payload = activityResponse.payload();
