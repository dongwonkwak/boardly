...
public class BoardListCreateService implements CreateBoardListUseCase {
    ...
    private Either<Failure, Void> validateCommand(
        ...
        ValidationResult<CreateBoardListCommand> validationResult =
            boardListValidator.validateCreateBoardList(command);
    ...
    private Either<Failure, Void> validateBusinessRules(
        ...
        if (
            command.title().length() > boardListPolicyConfig.getMaxTitleLength()
        ) {
            log.warn(
    ...
    private Either<Failure, BoardList> createAndSaveBoardList(
        ...
        try {
            var maxPositionResult =
                boardListRepository.findMaxPositionByBoardId(command.boardId());
